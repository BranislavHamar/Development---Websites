...
var WYSIWYG = {
	...
	Settings: function() {
		...
		this.DropDowns['headings'] = {	
			id: "headings",
			command: "FormatBlock",
			label: "<{value} style=\"margin:0px;text-decoration:none;font-family:Verdana\">Typ {value}</{value}>",
			width: "74px",
			elements: new Array(
/*				"H1",  */
				"H2",
...
/*				"H4", 
	...
	"bold":           ['Bold',                 'Tučné',               'bold.gif',               'bold_on.gif'],
	"italic":         ['Italic',               'Kurzivá',            	'italics.gif',            'italics_on.gif'],
	"underline":      ['Underline',            'Podčiarknuté',       	'underline.gif',          'underline_on.gif'],
	...
	"unorderedlist":  ['InsertUnorderedList',  'Vložiť zoznam v bodoch',	'list_unordered.gif',     'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Vložiť číselný zoznam',  	'list_ordered.gif',       'list_ordered_on.gif'],
	...
	"copy":           ['Copy',                 'Kopírovať',          	'copy.gif',               'copy_on.gif'],
	"paste":          ['Paste',                'Vložiť',             	'paste.gif',              'paste_on.gif'],
	...
	"undo":           ['Undo',                 'Krok späť',            	'undo.gif',               'undo_on.gif'],
	"redo":           ['Redo',                 'Krok dopredu',        	'redo.gif',               'redo_on.gif'],
	"inserttable":    ['InsertTable',          'Vložiť tabulku',        	'insert_table.gif',       'insert_table_on.gif'],
