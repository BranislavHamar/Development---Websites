...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // **************************************************
		...
		// **************************************************
         ...
         $cfg_cc_SubDomain_Name               = "http://www.tntzasilka.cz";
         $cfg_cc_SubDomain_Name_SSL           = "https://www.tntzasilka.cz";   //If certificate SSL installed then https
         
         $cfg_Sender_Country_Name             = "Czech republic";
         $cfg_Sender_Country_Code             = "cz";       //Low case country code
         $cfg_Sender_Country_Code_big         = mb_strtoupper($cfg_Sender_Country_Code);
         
         $cfg_links_myTNT                     = "https://my.tnt.com/myTNT/login/LoginInitial.do?respLang=cs&respCountry=cz";
         
         $cfg_links_Top                       = array("http://www.tnt.com/express/cs_cz/site/home.html",
                                                      "http://www.tnt.com/express/cs_cz/site/home/applications/tracking.html", 
                                                      "http://www.tnt.com/express/cs_cz/site/home/how-to-ship-parcel.html",
                                                      "http://www.tnt.com/express/cs_cz/site/home/help-center.html",
                                                      "http://www.tnt.com/express/cs_cz/site/home/the-company.html");
         $cfg_links_Bottom                    = array("http://www.tnt.com/express/cs_cz/site/home/terms-use.html",
                                                      "http://www.tnt.com/express/cs_cz/site/home/privacy-policy.html",
                                                      "http://www.tnt.com/express/cs_cz/site/home/terms-conditions.html");

         $cfg_csfl_subject                    = "Cislo objednavky: ";
         $cfg_csfl_email                      = "TNT <customer.service.prg@tnt.com>";
         $cfg_csfl_email_bounce               = "customer.service.prg@tnt.com";
         ...
         $cfg_csfl_message                    =  array("Dobry den,", 
                                                       "detaily k Vasí objednavce si muzete prohlednout zde: ", 
                                                       $cfg_cc_SubDomain_Name_SSL, 
                                                       "Nebo se muzete prihlasit do ".$cfg_cc_SubDomain_Name." s pristupy nize: ",
                                                       "Cislo objednavky",
                                                       "Zakaznicke cislo",
                                                       "Po kontrole a doplneni detailu si muzete ihned vytisknout dokumentaci.",
                                                       "Dekujeme, ze vyuzivate nase sluzby.",                                                      
                                                       "TNT, Zákaznicky servis, 848 000 868, ",
                                                       "---------------------------------------------------------------------------------",
                                                       "Chcete si sami vytvaret a spravovat zasilky?",
                                                       "Potom se zaregistrujte pres odkaz nize a vyuzijte nasi bezplatnou elektronickou sluzbu myTNT",
        ...
        $cfg_con_national_chars               =  array("ľ" => "l",
         ...
         $cfg_con_subject                    = "Cislo zasilky: ";
         $cfg_con_email                      = "TNT <customer.service.prg@tnt.com>";
         $cfg_con_email_bounce               = "customer.service.prg@tnt.com";         
         ...
         $cfg_con_message                    =  array("Dobry den,", 
                                                      "v nasledujicím odkaze muzete sledovat Vasi zasilku: ",
                                                      "", 
                                                      "http://www.tnt.com/content/express/cs_cz/site/home/applications/app_panel_tracking_main.html?navigation=0&searchType=CON&respLang=".$cfg_Sender_Country_Code."&respCountry=".$cfg_Sender_Country_Code."&genericSiteIdent=.&cons=", 
                                                      "Adresa vyzvednuti",
                                                      "Adresa doruceni",
                                                      "Popis zasilky",
                                                      "Pocet kusu",
                                                      "Vaha",
                                                      "Reference",
                                                      "Dekujeme, ze vyuzívate nase sluzby",                                                      
                                                      "TNT, Zákaznicky servis, 848 000 868, ",
                                                      "---------------------------------------------------------------------------------",
                                                      "Chcete si sami organizovat a spravovat vsechny Vase zasilky?",
                                                      "Pak nevahejte a registrujte se do myTNT.",
                                                      "https://my.tnt.com/myTNT/login/LoginInitial.do?respLang=cs&respCountry=cz",
                                                      ""
                                                      );                     
