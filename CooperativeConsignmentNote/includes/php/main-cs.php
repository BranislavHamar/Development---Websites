...
function content_web() 	{
		...
		global $crn, $senderaccount, $word, $lock, $flagprinted, $checkvalidate, $lang, $emailnotification, $rowid;
    ...
    global $cfg_con_option_names, $cfg_con_subject, $cfg_con_email, $cfg_con_email_bounce, $cfg_con_email_personal, $cfg_con_message, $cfg_con_mkt_detailedmanifest_media, $cfg_con_mkt_detailedmanifest_start, $cfg_con_mkt_detailedmanifest_end;
          ...
          $sql = "SELECT a.*, c.Name, c.Telephone, c.Email
                              ...
                              ON (IF (a.UserName IS NOT NULL, c.UserName, n.account_id) = a.account_id)  =   c.UserName = '' 
        ...
        <div id='submit'>
            <input ".($row['FlagPrinted']=='1' ? " disabled" : "")." id='termsAndConditions' type='checkbox' name='termsAndConditions' value='1' ".($row['TandC']=='1' ? " checked" : "")."> <a style='color:black;' target='_blank' href='".$cfg_links_Bottom[2]."'>".$word['10003']."</a>
